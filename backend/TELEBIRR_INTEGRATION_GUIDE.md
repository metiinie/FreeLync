...
Complete guide for integrating Telebirr payment gateway into FreeLync real estate marketplace.
...
Telebirr is Ethiopia's leading mobile payment platform. This guide will help you integrate Telebirr payment processing into your FreeLync application.
...
```json
{
  ...
  "subject": "FreeLync Payment - transaction-id",
  "totalAmount": "1000",
  "shortCode": "608986",
