...
const admin_identity_middleware_1 = require("./common/middleware/admin-identity.middleware");
const app_controller_1 = require("./app.controller");
let AppModule = class AppModule {
    configure(consumer) {
        consumer
            .apply(admin_identity_middleware_1.AdminIdentityMiddleware)
            .forRoutes('admin/*');
    }
};
...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            disputes_module_1.DisputeModule,
