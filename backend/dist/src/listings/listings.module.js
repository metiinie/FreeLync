...
const admin_listings_controller_1 = require("./admin-listings.controller");
...
exports.ListingsModule = ListingsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [listings_controller_1.ListingsController, admin_listings_controller_1.AdminListingsController],
